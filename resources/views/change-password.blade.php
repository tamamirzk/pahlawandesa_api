        ...
        <div class="container">
          <div class="row">
            ...
            <div class="col-md-9">
    		    ...
    		    Not to worry. Just enter your new password below and we'll recovery your account.
    		    <form action="{{ url('authentication/change-password') }}" method="POST" class="mt-3">
    		        <input class="form-control form-control-lg" name="password" type="password" placeholder="Your New Password" required/>
